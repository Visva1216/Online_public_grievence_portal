package in.gov.delhi.grievance.config;

import in.gov.delhi.grievance.security.JwtAuthenticationFilter;
import in.gov.delhi.grievance.security.CustomUserDetailsService;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                // Complaint endpoints - all authenticated users
